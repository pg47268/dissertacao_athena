...
if __name__ == '__main__':
    ...
    with open('/home/isabel/Desktop/test_athena_ard/classif/class4.csv', 'w') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(['vel_x', 'accel_x', 'ciclos', 'altura'])
        for k in range(len(hexapod.vx_data)):
                writer.writerow([hexapod.vx_data[k], hexapod.ax_data[k], hexapod.walker.t_data[k], hexapod.desv_data[k]])
    #------------------------------------------------
    ...
    with open('/home/isabel/Desktop/test_athena_ard/classif/forca_class4.csv', 'w') as csvfile:
        writer = csv.writer(csvfile)
