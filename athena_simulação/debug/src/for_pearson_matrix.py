    ...
    def classification(self, dt, imu_vx, desvio_total, it):
        ...
        if (it % 2 == 0 and it != 0):
            ...
            if inc >= 1:
                ...
                #print("REGULAR (t)")
            print("vel_x", imu_vx)
            print("RMS IRREG", rms(imu_vx))
            self.rms_imu.append(rms(imu_vx))
            # print("desvio", desvio)
            # self.desvio_total.append(desvio)
            ...
            if( it % 4 == 0 and it != 0):
                ...
                if(self.regularidade[0] == 1 and self.regularidade[1] == 1):
                    ...
                    # if 0.14 <= ((self.rms_imu[0] + self.rms_imu[0])/2) < 0.20:
...
if __name__ == '__main__':
    ...
    try:
        ...
        with open('/home/isabel/Desktop/tese/mix_3.csv', 'w') as csvfile:
